...
IDRegistry.genItemID("witherless_rose");
Item.createItem("witherless_rose", "witherless rose", { name: "witherless_rose", meta: 0 }, { stack: 1 });
...
IDRegistry.genItemID("angelic_feather");
Item.createItem("angelic_feather", "angelic feather", { name: "angelic_feather", meta: 0 }, { stack: 1 });
...
IDRegistry.genItemID("mercy_cross");
Item.createItem("mercy_cross", "mercy cross", { name: "mercy_cross", meta: 0 }, { stack: 1 });
